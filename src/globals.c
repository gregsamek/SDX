...
SDL_GPUGraphicsPipeline* pipeline_unanimated;
SDL_GPUGraphicsPipeline* pipeline_bone_animated;
SDL_GPUGraphicsPipeline* pipeline_rigid_animated;
SDL_GPUGraphicsPipeline* pipeline_instanced;
SDL_GPUGraphicsPipeline* pipeline_text;
SDL_GPUGraphicsPipeline* pipeline_fullscreen_quad;
SDL_GPUTexture* depth_texture;
SDL_GPUTexture* msaa_texture;
SDL_GPUTexture* virtual_screen_texture;
Uint32 virtual_screen_texture_width;
Uint32 virtual_screen_texture_height = 360;
SDL_GPUSampler* default_texture_sampler;
SDL_GPUBuffer* joint_matrix_storage_buffer;
SDL_GPUTransferBuffer* joint_matrix_transfer_buffer;