        ...
        .vertex_input_state = (SDL_GPUVertexInputState)
        {
            ...
            {
                {
                    .slot = 0,
                    .input_rate = SDL_GPU_VERTEXINPUTRATE_VERTEX,
                    .pitch = sizeof(Vertex_PositionNormalTexture) // MUST MATCH LOADED VERTEX DATA
                }
            },  
            ...
            .vertex_attributes = (SDL_GPUVertexAttribute[])
            {
                {   // position: TEXCOORD0
                    ...
                    .format = SDL_GPU_VERTEXELEMENTFORMAT_FLOAT3,
                    .location = 0,
                    .offset = offsetof(Vertex_PositionNormalTexture, x)
                },
                {   // normal: TEXCOORD1
                    .buffer_slot = 0,
                    .format = SDL_GPU_VERTEXELEMENTFORMAT_FLOAT3,
                    .location = 1,
                    .offset = offsetof(Vertex_PositionNormalTexture, nx)
                },
                {   // texture coordinate: TEXCOORD2
                    .buffer_slot = 0,
                    .format = SDL_GPU_VERTEXELEMENTFORMAT_FLOAT2,
                    .location = 2,
                    .offset = offsetof(Vertex_PositionNormalTexture, u)
                }
            }
        },
        .primitive_type = SDL_GPU_PRIMITIVETYPE_TRIANGLELIST,
